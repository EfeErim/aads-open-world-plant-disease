...
TRAINING_START_HERE_LINES = [
    ...
    "2. `adapter_behavioral_acceptance.json`",
    "3. `training/summary.json`",
    "4. `production_readiness.json` (uyumluluk/tani)",
    "5. `test/metric_gate.json`",
    "6. `ood_benchmark/summary.json` veya `test/ood_evidence_summary.json`",
    "",
    "Tanı için:",
...
TRAINING_STATIC_ENTRY_SPECS = [
    {
        "relative_path": "adapter_behavioral_acceptance.json",
        "category": "ood_and_readiness",
        "priority": "critical",
        "title_tr": "Adapter davranissal kabul karari",
        "description_tr": "ID siniflandirma ve ayni urun desteklenmeyen hastalik reddi icin ana karar dosyasi.",
        "reader_goal": "Adapterin varsayilan kabul sozlesmesini gecip gecmedigini anlamak",
        "decision_importance": "adapter_acceptance_decision",
        "read_order": 1,
    },
    {
